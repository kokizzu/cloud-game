import { pub, TRANSFORM_CHANGE } from "event";
...
const rescaleGameBoy = (targetWidth, targetHeight) => {
    ...
    const scale = Math.min(
        targetWidth / getWidth(gameBoy),
        targetHeight / getHeight(gameBoy),
    );
...
new MutationObserver(() => pub(TRANSFORM_CHANGE)).observe(gameBoy, {
